  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="w-full bg-black py-24 flex justify-center items-center">
        <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-0 rounded-2xl overflow-hidden shadow-2xl">
          {/* Left Card */}
          <div className="bg-black flex flex-col justify-between p-10 min-h-[500px] relative">
            <div className="absolute left-0 top-10 -translate-y-1/2 rotate-[-90deg] text-white/60 text-sm tracking-widest origin-left select-none" style={{writingMode: 'vertical-lr', textOrientation: 'mixed'}}>Our services</div>
            <div className="flex flex-col items-center justify-center h-full">
              <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-6">What MIPL’s Known For</h2>
              <img src="https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&w=400&q=80" alt="Business Service" className="rounded-lg mb-8 w-64 h-56 object-cover shadow-lg" />
          ...
          {/* Right Card */}
          <div className="bg-white/5 flex flex-col justify-between p-10 min-h-[500px] relative">
            <div className="absolute right-0 bottom-10 translate-y-1/2 rotate-90 text-white/60 text-sm tracking-widest origin-right select-none" style={{writingMode: 'vertical-lr', textOrientation: 'mixed'}}>Build a career</div>
            <div className="flex flex-col h-full justify-between">
              <div className="relative mb-8">
                <img src="https://images.pexels.com/photos/1181355/pexels-photo-1181355.jpeg?auto=compress&w=400&q=80" alt="Career" className="rounded-lg w-full h-56 object-cover opacity-60" />
                <h2 className="absolute top-6 left-6 text-3xl md:text-4xl font-bold text-white">Looking for a Real Career?</h2>
                <p className="absolute top-24 left-6 right-6 text-white/90 text-base md:text-lg font-medium max-w-md">Our team is made up of passionate people who love to create. We are constantly on a look out for talented, high-performing, and enthusiastic people to join our team.</p>
              </div>
              <button className="flex items-center gap-3 mt-4 text-lg font-medium text-white px-6 py-3 rounded-full border border-white bg-black hover:bg-white hover:text-black transition">
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-full border border-white bg-black">
                  <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
